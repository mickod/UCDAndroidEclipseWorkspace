...
public class TableFeedbackActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button tableBackButton = (Button) findViewById(R.id.TableBackButton);
        tableBackButton.setOnClickListener(new View.OnClickListener() {
        ...
        final Button clearButton = (Button) findViewById(R.id.TableClearButton);
        ...
        final Button sendButton = (Button) findViewById(R.id.TableSendButton);
