...
public class LinearFeedbackActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button linearButton = (Button) findViewById(R.id.LinearBackButton);
        ...
        final Button clearButton = (Button) findViewById(R.id.LinearClearButton);
        ...
        final Button sendButton = (Button) findViewById(R.id.LinearSendButton);
